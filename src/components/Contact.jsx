      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg-flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
            Reach out today to discuss your Projects needs and start
        ...
        <form
          action="https://getform.io/f/bejlzrja"
          method="POST"
          className="xl:pl-10 2xl:pl-20 mb-4"
        >
          ...
          <button
            type="submit"
            className="btn btn-primary [&]:max-w-full w-full justify-center mb-4"
          >
            Submit
          </button>
        </form>
